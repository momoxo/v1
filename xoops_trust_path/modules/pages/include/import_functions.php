...
function pages_import_a_content_from_pages( $mydirname , $import_mid , $content_id )
{
	...
	$columns4sql = implode( ',' , array_diff( $GLOBALS['pages_tables']['contents'] , array( 'content_id' , 'cat_id') ) ) ;
	...
	$columns4sql = implode( ',' , array_diff( $GLOBALS['pages_tables']['content_votes'] , array( 'vote_id' , 'content_id' ) ) ) ;
