...
if( defined( 'FOR_XOOPS_LANG_CHECKER' ) ) $mydirname = 'pages' ;
...
define($constpref.'_EF_CLASSDSC' , 'Change it if you want to override the handler for extra_fields. The default value is PagesExtraFields');
define($constpref.'_URIM_CLASS' , 'class mapping URI');
define($constpref.'_URIM_CLASSDSC' , 'Change it if you want to override the URI mapper. The default value is PagesUriMapper');
