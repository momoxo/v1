...
define($constpref.'_EF_CLASSDSC' , 'extra_fields処理をオーバーライドしたい時に指定。デフォルトはPagesExtraFields');
define($constpref.'_URIM_CLASS' , 'URIマッピング処理クラス名');
define($constpref.'_URIM_CLASSDSC' , 'URIマッパーをオーバーライドしたい時に指定。デフォルトはPagesUriMapper');
...
define($constpref.'_COM_POSTSNUM','一覧表示件数');
