...
define( 'PAGES_URI_MAPPER_ALLOW_CONTENT_ID_OVERWRITING' , true ) ;
...
if( ! empty( $_POST['contentman_preview'] ) ) {
	...
	$controller_class = 'PagesControllerCopywaitingContent' ;
} else if( ! empty( $_POST['contentman_delete'] ) ) {
	$controller_class = 'PagesControllerDeleteContent' ;
} else if( ! empty( $_POST['contentman_reject_apply'] ) ) {
	$controller_class = 'PagesControllerRejectApplyContent' ;
} else if( ! empty( $_POST['contentman_post'] ) ) {
	$controller_class = 'PagesControllerUpdateContent' ;
} else {
