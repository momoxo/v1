...
class PagesControllerGetHistory extends PagesControllerAbstract {
...
function execute( $request )
{
	...
	list( , , $history_body ) = pages_get_content_history_profile( $this->mydirname , $request['content_history_id'] ) ;
	$this->assign['history_body_raw'] = $history_body ;

	// breadcrumbs
	$breadcrumbsObj->appendPath( '' , _MD_PAGES_HISTORY ) ;
