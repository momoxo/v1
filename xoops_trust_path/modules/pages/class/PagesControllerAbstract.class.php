...
class PagesControllerAbstract {

var $mydirname = '' ;
var $mytrustdirname = 'pages' ;
var $assign = array() ;
...
function PagesControllerAbstract( &$currentCategoryObj )
{
	global $xoopsUser ;
...
function render( $target = null )
{
	...
	$tpl->assign( 'xoops_module_header' , pages_main_render_moduleheader( $this->mydirname , $GLOBALS['xoopsModuleConfig'] , $this->getHtmlHeader() ) ) ;
...
function getTemplateName()
{
	...
	if( class_exists( 'XCube_DelegateUtils' ) ) {
		XCube_DelegateUtils::raiseEvent( 'ModuleClass.Pages.Controller.GetTemplateName' , $this->mydirname , new XCube_Ref( $template_name ) ) ;
	}
