...
class PagesD3commentContent extends D3commentAbstract {
...
function fetchSummary( $external_link_id )
{
	...
	list( $categoryObj , $contentObj ) = pages_common_get_objects_from_content_id( $mydirname , $content_id ) ;
	...
	return array(
		...
		'uri' => XOOPS_URL.'/modules/'.$mydirname.'/'.pages_common_make_content_link4html( $configs , $content_data ) ,
		'summary' => $summary ,
	) ;
}
