...
$GLOBALS['pages_blocks_tags_order_options'] = array(
	'count ASC' => 'count ASC' ,
...
function b_pages_tags_show( $options )
{
	global $pages_blocks_tags_order_options ;
	...
	$listorder = in_array( @$options[2] , $pages_blocks_tags_order_options ) ? $options[2] : 'count DESC' ;
	$sqlorder = in_array( @$options[3] , $pages_blocks_tags_order_options ) ? $options[3] : 'count DESC' ;
...
function b_pages_tags_edit( $options )
{
	global $pages_blocks_tags_order_options ;
	...
	$tpl->assign( array(
		...
		'listorder' => $listorder ,
		'sqlorder' => $sqlorder ,
		'order_options' => $pages_blocks_tags_order_options ,
