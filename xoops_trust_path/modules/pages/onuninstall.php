...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return pages_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'pages_onuninstall_base' ) ) {

function pages_onuninstall_base( $module , $mydirname )
{
...
function pages_message_append_onuninstall( &$module_obj , &$log )
{
