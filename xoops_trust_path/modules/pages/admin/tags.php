...
if( ! empty( $_POST['tags_update'] ) ) {
	...
	redirect_header( XOOPS_URL."/modules/$mydirname/admin/index.php?page=tags" , 3 , _MD_PAGES_MSG_UPDATED ) ;
	exit ;
}
...
if( ! empty( $_POST['tags_delete'] ) && ! empty( $_POST['action_selects'] ) ) {
	...
	redirect_header( XOOPS_URL."/modules/$mydirname/admin/index.php?page=tags" , 3 , _MD_A_PAGES_MSG_DELETED ) ;
	exit ;
}
