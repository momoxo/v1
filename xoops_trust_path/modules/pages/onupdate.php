...
eval( ' function xoops_module_update_'.$mydirname.'( $module ) { return pages_onupdate_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'pages_onupdate_base' ) ) {

function pages_onupdate_base( $module , $mydirname )
{
...
function pages_message_append_onupdate( &$module_obj , &$log )
{
