...
if( is_object( @$GLOBALS['xoopsModule'] ) && $GLOBALS['xoopsModule']->getVar('dirname') == $mydirname ) {
	...
	$modversion['sub'] = pages_common_get_submenu( $mydirname ) ;
} else {
...
$modversion['blocks'][1] = array(
	...
	'description'	=> '' ,
	'show_func'		=> 'b_pages_menu_show' ,
	'edit_func'		=> 'b_pages_menu_edit' ,
	'options'		=> "$mydirname||" ,
...
$modversion['blocks'][2] = array(
	...
	'description'	=> '' ,
	'show_func'		=> 'b_pages_content_show' ,
	'edit_func'		=> 'b_pages_content_edit' ,
...
$modversion['blocks'][3] = array(
	...
	'description'	=> '' ,
	'show_func'		=> 'b_pages_list_show' ,
	'edit_func'		=> 'b_pages_list_edit' ,
...
$modversion['blocks'][4] = array(
	...
	'description'	=> '' ,
	'show_func'		=> 'b_pages_subcategories_show' ,
	'edit_func'		=> 'b_pages_subcategories_edit' ,
	'options'		=> "$mydirname|0|" ,
	'template'		=> '' , // use "module" template instead
	'can_clone'		=> true ,
) ;
...
$modversion['blocks'][5] = array(
	...
	'description'	=> '' ,
	'show_func'		=> 'b_pages_mywaitings_show' ,
	'edit_func'		=> 'b_pages_mywaitings_edit' ,
	'options'		=> "$mydirname|" ,
	'template'		=> '' , // use "module" template instead
	'can_clone'		=> true ,
) ;
...
$modversion['blocks'][6] = array(
	...
	'description'	=> '' ,
	'show_func'		=> 'b_pages_tags_show' ,
	'edit_func'		=> 'b_pages_tags_edit' ,
...
$modversion['config'][] = array(
	...
	'formtype'		=> 'text' ,
	'valuetype'		=> 'text' ,
	'default'		=> 'PagesAutoRegisterWraps' ,
	'options'		=> array()
) ;
