...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return pages_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'pages_oninstall_base' ) ) {

function pages_oninstall_base( $module , $mydirname )
{
...
function pages_message_append_oninstall( &$module_obj , &$log )
{
