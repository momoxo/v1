...
if( ! class_exists( 'PagesPreloadBase' ) ) {


class PagesPreloadBase extends XCube_ActionFilter
{
	var $mydirname = 'pages' ;
...
if( ! is_numeric( $mydirname{0} ) ) {
	...
	eval( 'class '.ucfirst( $mydirname ).'_PagesPreload extends PagesPreloadBase { var $mydirname = "'.$mydirname.'" ; }' ) ;
}
