...
function smarty_function_pages_category_search( $params , &$smarty )
{
	...
	foreach( $mydirnames as $mydirname ) {
		...
		while( $cat_row = $db->fetchArray( $result ) ) {
			$category4assign = array(
				...
				'link' => pages_common_make_category_link4html( $configs , $cat_row ) ,
				...
				'paths_value' => array_values( pages_common_unserialize( $cat_row['cat_path_in_tree'] ) ) ,
